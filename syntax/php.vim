...
if exists("php_parent_error_open")
  ...
  syn region  phpComment  start="/\*" end="\*/" contained keepend contains=phpTodo,phpDocComment extend
  syn region  phpDocComment  start="/\*\*" end="\*/" contains=phpTodo fold
endif
if version >= 600
...
if version >= 508 || !exists("did_php_syn_inits")
  ...
  HiLink   phpDocComment phpComment
